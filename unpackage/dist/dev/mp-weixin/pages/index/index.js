...
/* harmony import */ var _index_vue_vue_type_template_id_f1bf9be6___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=f1bf9be6& */ 18);
...
//
//
var _default = { data: function data() {return { advertList: [] };}, onLoad: function onLoad(options) {var _this = this;(0, _index.getIndexList)().then(function (res) {if (res.data.code == 100) {console.log(res);_this.advertList = res.data.info.advertList;} else {return uni.showToast({ title: '获取数据失败' });}}); // getWxDecode(this.encryptedData,this.iv,this.code).then(res => {
    // 		console.log(res)
    // }),
